...
import {
  eventBodySchema, eventListQuerySchema, eventParamsSchema, eventRegistrationBodySchema, eventRegistrationCancelQuerySchema, eventUpdateBodySchema
...
eventsRouter.delete("/:id/registrations", validateRequest({ params: eventParamsSchema, query: eventRegistrationCancelQuerySchema }), asyncHandler(eventsController.cancelRegistration));
